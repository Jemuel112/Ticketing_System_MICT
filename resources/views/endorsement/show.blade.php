        ...
        <div class="col-md-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title"><b>{{$endorse->title}}</b></h3>
                ...
                <div class="card-body p-2">
                    <div class="mailbox-read-info p-2">
                        ...
                        <h6> <b> From: </b> <a href="#">{{$user->fname." ".$user->lname." (".$user->department.")"}}</a>
                            <span class="mailbox-read-time float-right">{{date('F d, Y   h:i A', strtotime($endorse->created_at))}}</span></h6>
                        @if($to)
                            <h6>To:
                                @foreach($to as $users)
